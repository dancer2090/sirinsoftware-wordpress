...
<?php endif; ?>
	...
	<div class="section">
		<div class="inner">
			<div class="head">
					<h3><?php echo __('Business Divisions', 'sirinsoftware')?></h3>				
				</div>
			<?php $divisions = get_field('about_business_divisions');
			if( $divisions ): ?>
							...
							<div class="pic-text">
								...
								<div class="text">
									...
									<div class="buttons">
										...
										<div class="b2">
											<a class="btn btn-07" href="<?php echo site_url();?>/case-studies/">
												<i class="ico ico-portfolio-2"><i></i></i>
												<span><?php echo __('Portfolio', 'sirinsoftware')?></span>
											</a>
										</div>
										<div class="b3">
											<a class="btn btn-01 btn-scroll-to" href="#tellabout">
	...
	<?php the_field('about_graphic');?>
	<div class="section">
		<div class="inner">
			<h2><span><?php echo __('Pricing models', 'sirinsoftware')?></span></h2>
			<ul class="table-row first">
				<li class="head-cell"><?php echo __('Project type', 'sirinsoftware')?></li>
				<li><?php echo __('Project size', 'sirinsoftware')?></li>
				<li><?php echo __('Flexibility', 'sirinsoftware')?></li>
				<li><?php echo __('Clients control', 'sirinsoftware')?></li>
				<li><?php echo __('Requirements', 'sirinsoftware')?></li>
				<li><?php echo __('Scope and cost changes', 'sirinsoftware')?></li>
				<li class="last-cell"><?php echo __('Project management', 'sirinsoftware')?></li>
			</ul>
			<ul class="table-row fixed-price">
				<li class="head-cell"><?php echo __('Fixed Price', 'sirinsoftware')?><br><img src="https://sirinsoftware.com/wp-content/themes/sirinsoftware/img/img-04-25-white.png" alt="Fixed Price"></li>
				<li><?php echo __('small & medium', 'sirinsoftware')?></li>
				<li><?php echo __('-', 'sirinsoftware')?></li>
				<li><?php echo __('little', 'sirinsoftware')?></li>
				<li><?php echo __('defined', 'sirinsoftware')?></li>
				<li><?php echo __('defined', 'sirinsoftware')?></li>
				<li class="last-cell"><?php echo __('Waterfall', 'sirinsoftware')?></li>
			</ul>
			<ul class="table-row first mobile">
				<li class="head-cell"><?php echo __('Project type', 'sirinsoftware')?></li>
				<li><?php echo __('Project size', 'sirinsoftware')?></li>
				<li><?php echo __('Flexibility', 'sirinsoftware')?></li>
				<li><?php echo __('Clients control', 'sirinsoftware')?></li>
			...
			<ul class="table-row dedicated-team">
				<li class="head-cell"><?php echo __('Dedicated team', 'sirinsoftware')?><br><img src="https://sirinsoftware.com/wp-content/themes/sirinsoftware/img/img-04-21-white.png" alt="Dedicated team"></li>
				<li><?php echo __('medium & large', 'sirinsoftware')?></li>
				<li><?php echo __('+', 'sirinsoftware')?></li>
				<li><?php echo __('full', 'sirinsoftware')?></li>
				<li><?php echo __('evolving', 'sirinsoftware')?></li>
				<li><?php echo __('May vary', 'sirinsoftware')?></li>
				<li class="last-cell"><?php echo __('Agile', 'sirinsoftware')?></li>
			</ul>
		</div>
	</div>
	<div class="section our-story">
		<div class="inner">
			<div class="head">
				<h3><?php echo __('Our Story', 'sirinsoftware')?></h3>				
			</div>
			<div class="descript">
				<div class="pic-text">
					<div class="pic">
